...
obstacles = []
obstacles.append( rectangle( ax, pos = np.array([-5.73449,0.759494 ]), width = 0.15, height = 6.7 ) )        
obstacles.append( rectangle( ax, pos = np.array([-1.73449, 4.73449]), width = 0.15, height = 3.65 ) )
obstacles.append( rectangle( ax, pos = np.array([0.765507,1.73449]), width = 0.15, height = 4.65 ) )
obstacles.append( rectangle( ax, pos = np.array([0.765507,-4.51551]), width = 0.15, height = 4.15 ) )
obstacles.append( rectangle( ax, pos = np.array([3.26551,-6.51551]), width = 5.15, height = 0.15 ) )
obstacles.append( rectangle( ax, pos = np.array([3.26551,3.98449]), width = 5.15, height = 0.15 ) )
obstacles.append( rectangle( ax, pos = np.array([-2.48449,-2.51551]), width = 6.65, height = 0.15 ) )
obstacles.append( rectangle( ax, pos = np.array([-4.58449,5.25949]), width = 3.51043, height = 0.15 ) )# yaw: 0.816967
obstacles.append( rectangle( ax, pos = np.array([-1.48449,-0.515506]), width = 4.65, height = 0.15 ) )
obstacles.append( rectangle( ax, pos = np.array([-3.73449,1.23449]), width = 0.15, height = 3.65 ) )
obstacles.append( rectangle( ax, pos = np.array([-2.73449,2.98449]), width = 2.12, height = 0.15 ) )
