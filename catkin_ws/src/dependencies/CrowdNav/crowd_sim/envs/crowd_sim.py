...
class CrowdSim(gym.Env):
    ...
    def reset_custom(self, phase='test', test_case=None):
        """
        ...
        if 1:#not self.robot.policy.multiagent_training:
    ...
    def step_custom(self, action, update=True):
        """
    ...
    def render(self, mode='human', output_file=None, fig=None, ax=None):
