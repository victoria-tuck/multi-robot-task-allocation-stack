...
def generate_launch_description():
    ...
    # AWS Environment
    aws_directory = get_package_share_directory('aws_robomaker_hospital_world')
    aws_launch = IncludeLaunchDescription( PythonLaunchDescriptionSource( os.path.join(aws_directory, 'launch/view_hospital.launch.py') ) )
    ld.add_action(aws_launch)
