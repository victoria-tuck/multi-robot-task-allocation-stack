...
class RobotController(Node):
    ...
    def run_controller(self):
        ...
        # elif self.goal_init:
        #     self.get_logger().info(f"{self.name} did not try to plan b/c goal is already initialized.")
        # elif self.new_goal_poses is None:
        #     self.get_logger().info(f"{self.name} did not try to plan because there are no new goal poses.")
