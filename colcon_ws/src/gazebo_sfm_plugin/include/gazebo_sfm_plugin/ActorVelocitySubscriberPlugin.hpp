...
/**
  ...
  \endcode
*/
class ActorVelocitySubscriberPlugin : public gazebo::ModelPlugin
{
public:
  /// Constructor
  ActorVelocitySubscriberPlugin();

  /// Destructor
  virtual ~ActorVelocitySubscriberPlugin();
...
private:
  ...
  std::unique_ptr<ActorVelocitySubscriberPluginPrivate> impl_;
};
