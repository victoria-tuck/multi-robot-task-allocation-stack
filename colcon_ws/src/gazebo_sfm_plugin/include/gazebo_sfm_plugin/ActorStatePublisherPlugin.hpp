...
/**
  ...
  \endcode
*/
class ActorStatePublisherPlugin : public gazebo::ModelPlugin
{
public:
  /// Constructor
  ActorStatePublisherPlugin();

  /// Destructor
  virtual ~ActorStatePublisherPlugin();
...
private:
  ...
  std::unique_ptr<ActorStatePublisherPluginPrivate> impl_;
};
