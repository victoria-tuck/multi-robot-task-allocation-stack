...
/**
  ...
  \endcode
*/
class ModelStatePublisherPlugin : public gazebo::ModelPlugin
{
public:
  /// Constructor
  ModelStatePublisherPlugin();

  /// Destructor
  virtual ~ModelStatePublisherPlugin();
...
private:
  ...
  std::unique_ptr<ModelStatePublisherPluginPrivate> impl_;
};
